...
public class RegistrationTest {
    ...
    public static void TestCase001(){
        ...
        Email.clear();
        Email.sendKeys("lononoaooaaatttttttaufffikkk@gmail.com");
        ...
        public static void TestCase002() {
            ...
            WebElement Email = driver.findElement(By.id("input-email"));
            Email.clear();
            Email.sendKeys("bppb2jjjok00hllosoorrffaat1taauufikk@gmail.com");
    ...
    public static void TestCase003() {
        ...
        WebElement Email = driver.findElement(By.id("input-email"));
        Email.clear();
        Email.sendKeys("111333221123555556634122233");
    ...
    public static void TestCase004() {
        ...
        WebElement Email = driver.findElement(By.id("input-email"));
        Email.clear();
        Email.sendKeys("wwwaassstkloollpoihhhoiott@gmail.com");
    ...
    public static void TestCase005() {
        ...
        WebElement Email = driver.findElement(By.id("input-email"));
        Email.clear();
        Email.sendKeys("wwwpopjjjnyyytrdssssassstkklott@gmail.com");
    ...
    public static void TestCase006() {
        ...
        WebElement Email = driver.findElement(By.id("input-email"));
        Email.clear();
        Email.sendKeys("sjjjjkkkksssasssttt@gmail.com");
